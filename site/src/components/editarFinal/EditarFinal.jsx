...
import styles from '../../pages/formsDashboard/Forms.module.css';
import api from "../../api";
import { toast } from 'react-toastify';
import { useNavigate } from "react-router-dom";

function EditarFinal({ closeModal }) {
        ...
        <div className={styles.form}>
            ...
            <form aria-labelledby="editar-usuarios-form" onSubmit={salvarUsuario}>
                ...
                <input
                    ...
                    id="email"
                    name="email"
                    placeholder={usuario ? usuario.email || "Email" : ""}
                    aria-required="true"
                    value={email}
