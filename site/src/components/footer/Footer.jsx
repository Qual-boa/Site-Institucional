    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.menu}>
                    ...
                    <a className={styles.options} href="#outra-pagina" smooth={true} onClick={() => scrollToSection('cidades')}>CIDADES MAIS PROCURADAS</a>
                    <a className={styles.options} href="#outra-pagina" smooth={true} onClick={() => scrollToSection('bares')}>BARES MAIS VISTOS</a>
                    <a className={styles.options} href="#outra-pagina" smooth={true} onClick={() => scrollToSection('sugestoes')}>SUGESTÔES DO MÊS</a>
                    <a className={styles.options} href="#outra-pagina" smooth={true} onClick={() => scrollToSection('boa')}>QUAL A SUA BOA?</a>                    
                    <a className={styles.options} href="#outra-pagina" smooth={true} onClick={() => quemSomosSection('quem-somos')}>QUEM SOMOS</a>
                </div>
                <div className={styles.menu}>
